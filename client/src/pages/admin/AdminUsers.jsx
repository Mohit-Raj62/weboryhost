            ...
            {users.length === 0 ? (
              ...
              users.map((user) => (
                <tr key={user._id || user.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-xs text-gray-700 font-mono select-all">{user._id || user.id || '-'}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{user.joinDate ? new Date(user.joinDate).toLocaleDateString() : '-'}</div>
                  </td>
