                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">32.4%</dd>
                        <dd className="text-sm text-red-600">+2.1% from last month</dd>
                      </dl>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">4m 32s</dd>
                        <dd className="text-sm text-green-600">+15.3% from last month</dd>
                      </dl>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { page: '/about', views: 6540, change: '+15%' },
                    { page: '/contact', views: 4320, change: '+5%' },
                    { page: '/blog', views: 3890, change: '+22%' }
                  ].map((item, index) => (
                    <div key={index} className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-gray-700">Mobile Users</span>
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-4">
                  {[
                    { title: 'Web Development Guide', views: 2340, engagement: 89, status: 'trending' },
                    { title: 'SEO Best Practices', views: 1890, engagement: 76, status: 'stable' },
                    { title: 'Design Trends 2024', views: 1560, engagement: 92, status: 'trending' },
                    { title: 'E-commerce Solutions', views: 1230, engagement: 68, status: 'declining' }
                  ].map((content, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="text-sm font-medium text-gray-900 truncate">{content.title}</h4>
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full ${
                          content.status === 'trending' ? 'bg-green-100 text-green-800' :
                          content.status === 'stable' ? 'bg-blue-100 text-blue-800' :
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  { role: 'Administrator', count: 2, color: 'purple', permissions: ['Full access', 'User management', 'System settings'] },
                  { role: 'Moderator', count: 3, color: 'blue', permissions: ['Content moderation', 'User moderation', 'Comment management'] },
                  { role: 'Editor', count: 5, color: 'green', permissions: ['Content creation', 'Post editing', 'Draft management'] },
                  { role: 'User', count: 150, color: 'gray', permissions: ['View content', 'Comment', 'Profile management'] }
                ].map((roleInfo) => (
                  <div key={roleInfo.role} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 text-xs font-semibold rounded-full bg-${roleInfo.color}-100 text-${roleInfo.color}-800`}>
                        {roleInfo.count}
                      </span>
                    </div>
          ...
          <div className="space-y-8">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="space-y-6">
                ...
                {/* System Controls */}
                <div>
                  <h3 className="text-md font-medium text-gray-900 mb-4">System Controls</h3>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          systemSettings.userRegistration ? 'bg-green-600' : 'bg-gray-200'
                        }`}
                      >
                        <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                ...
                {/* Integrations */}
                <div>
                  <h3 className="text-md font-medium text-gray-900 mb-4">Third-Party Integrations</h3>
                  <div className="space-y-4">
                    {[
                      { key: 'googleAnalytics', name: 'Google Analytics', description: 'Track website traffic and user behavior' },
                      { key: 'facebookPixel', name: 'Facebook Pixel', description: 'Track conversions and optimize ads' },
                      { key: 'mailchimp', name: 'Mailchimp', description: 'Email marketing and newsletter management' }
                    ].map((integration) => (
                        ...
                        <button
                          onClick={() => setSystemSettings({
                            ...
                            integrations: {
                              ...
                              [integration.key]: !systemSettings.integrations[integration.key]
                            }
                          })}
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            systemSettings.integrations[integration.key] ? 'bg-green-600' : 'bg-gray-200'
                          }`}
                        >
                          <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                            systemSettings.integrations[integration.key] ? 'translate-x-6' : 'translate-x-1'
                          }`} />
                        </button>
                      </div>
                    ))}
